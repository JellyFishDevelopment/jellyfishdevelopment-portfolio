...
export default function Page() {
  ...
  <h1 className='header-title text-8xl font-extrabold text-center pt-16'>Quem<span className='Fish'>Somos</span></h1>

  <p className='text-neutral-400 pt-5 font-normal'>o time por trás da excelência e inovação que <strong>acontece</strong> 💡</p>
