              ...
              <div className="relative h-full p-6 rounded-[inherit] z-20 overflow-hidden">
                ...
                <div className="flex flex-col h-full text-left">
                  ...
                  <div>
                    ...
                    <p className="font-normal p-3">
                      Site dinâmico e minimalista de busca e documentação sobre
                      Software Defined Storage baseado em Astro, utilizando
              ...
              <div className="relative h-full p-6 rounded-[inherit] z-20 overflow-hidden">
                ...
                <div className="flex flex-col h-full text-left">
                  ...
                  <div>
                    ...
                    <p className="font-normal p-3">
                      Site estático dedicado à Consultoria Jurídica, projetado
                      para fornecer informações claras e acessíveis sobre os
