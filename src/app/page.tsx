  ...
  return (
    <>
        ...
        <div className='flex flex-row pb-20'>
          ...
          <section className='w-5/6 border rounded-tl-3xl rounded-br-3xl p-10'>
            <h2 className='text-2xl font-bold text-center'>Vamos trabalhar juntos!</h2>
            <p className='pt-5 pb-5'>Na <b>Jelly<span className='Fish'>Fish</span></b> acreditamos no poder da colaboração para criar soluções digitais excepcionais. Se você tem uma visão, nós temos a ferramenta. Venha conosco transformar suas ideias em realidade. <b><span className='Fish'>Conecte-se</span></b> conosco e embarque nesta jornada.</p>

              <div className='flex gap-5'>
                <button className="items-center bg-white border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none">
                <span className='font-bold'>Contate-nos</span>
                </button>

                <button
                  className="flex items-center bg-black border rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-white hover:bg-gray-950 focus:outline-none">
                ...
                <button
                  className="flex items-center border border-red-950 bg-red-900 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-white hover:bg-red-950 focus:outline-none">
