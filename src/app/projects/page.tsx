  ...
  return (
    <>
      ...
      <section className='flex flex-col items-center font-extrabold pt-16'>
        ...
        <h1 className='header-title text-6xl font-extrabold text-center pt-16'><span className='Fish'>Projects</span>.</h1>
        <div className='flex grid-cols-3 pt-5'>
          <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24"><path fill="#ffffff" d="m14 17l-5-5l5-5z"></path></svg>
          <h1 className='header-title text-3xl font-extrabold text-center'>Front-end/Web</h1>
          <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24"><path fill="#ffffff" d="M10 17V7l5 5z"></path></svg>
        ...
        <section className='py-10 grid justify-items-center'>
          ...
          <h1 className='header-title text-3xl font-extrabold text-center'>Site - SDS Wiki</h1>
          <h1 className='font-normal w-auto text-slate-200'>Site de busca e documentação sobre Software Defined Storage baseado em Astro, utilizando arquivos em markdown.</h1>
        </section>
        ...
        <section className='py-10 grid justify-items-center'>
          ...
          <h1 className='header-title text-3xl font-extrabold text-center'>Site - JM Engenharia Elétrica</h1>
          <h1 className='font-normal w-auto text-slate-200'>Site institucional sobre elétrica e soluções em energia, usando API de envio de e-mail, baseado em React.</h1>
        </section>
      ...
      {/* Projects */}
        <section className='py-10 grid justify-items-center'>
          ...
          <h1 className='header-title text-3xl font-extrabold text-center'>Site - Luciana Advocacia e Consultoria</h1>
          <h1 className='font-normal w-auto text-slate-200'>Site estático dedicado à Consultoria Jurídica, projetado para fornecer informações sobre os serviços jurídicos oferecidos.</h1>
        </section>
